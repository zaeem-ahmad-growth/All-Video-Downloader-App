...
| [#matrix](tabs/02-aso-playbook.md#matrix) | Rank tracker | Where each competitor ranks, keyword by keyword | [L92](../tabs/02-aso-playbook/index.html#L92) | `renderScoped()` [L652-678](../assets/app.js#L652)<br>`renderMatrix()` [L147-153](../assets/app.js#L147) | `data.apps`, `data.compIdx` |
| [#serps](tabs/02-aso-playbook.md#serps) | Result slots | Every search, slot by slot | [L105](../tabs/02-aso-playbook/index.html#L105) | `renderStrips()` [L154-161](../assets/app.js#L154)<br>`renderScoped()` [L652-678](../assets/app.js#L652) |  |
...
| Section | Menu label | Heading in the markup | Markup line | Filled by (assets/app.js) | Data read |
| --- | --- | --- | --- | --- | --- |
| [#features](tabs/04-features-comparison.md#features) |  | Features Comparison | [L29](../tabs/04-features-comparison/index.html#L29) | `renderFeatures()` [L480-532](../assets/app.js#L480) | `data.apps`, `data.board.US`, `data.claims`, `data.markets`, `data.profiles.claims`, `features.audit`, `features.edges`, `features.inventory`, `features.oursOnly`, `features.plans.items`, `features.plans.note`, `graphics`, `listing.current.iap` |
| [#f-overview](tabs/04-features-comparison.md#f-overview) | Overview | Features Comparison | [L30](../tabs/04-features-comparison/index.html#L30) | `renderFeatures()` [L480-532](../assets/app.js#L480) | `data.apps`, `data.board.US`, `data.claims`, `data.markets`, `data.profiles.claims`, `features.audit`, `features.edges`, `features.inventory`, `features.oursOnly`, `features.plans.items`, `features.plans.note`, `graphics`, `listing.current.iap` |
| [#f-lead](tabs/04-features-comparison.md#f-lead) | Only in our app | What only this app does | [L37](../tabs/04-features-comparison/index.html#L37) | `renderFeatures()` [L480-532](../assets/app.js#L480) | `data.apps`, `data.board.US`, `data.claims`, `data.markets`, `data.profiles.claims`, `features.audit`, `features.edges`, `features.inventory`, `features.oursOnly`, `features.plans.items`, `features.plans.note`, `graphics`, `listing.current.iap` |
| [#f-audit](tabs/04-features-comparison.md#f-audit) | Audit matrix | Feature audit matrix | [L42](../tabs/04-features-comparison/index.html#L42) | `renderFeatures()` [L480-532](../assets/app.js#L480) | `data.apps`, `data.board.US`, `data.claims`, `data.markets`, `data.profiles.claims`, `features.audit`, `features.edges`, `features.inventory`, `features.oursOnly`, `features.plans.items`, `features.plans.note`, `graphics`, `listing.current.iap` |
| [#f-claims](tabs/04-features-comparison.md#f-claims) | Listing claims | What each listing tells users it can do | [L53](../tabs/04-features-comparison/index.html#L53) | `renderFeatures()` [L480-532](../assets/app.js#L480) | `data.apps`, `data.board.US`, `data.claims`, `data.markets`, `data.profiles.claims`, `features.audit`, `features.edges`, `features.inventory`, `features.oursOnly`, `features.plans.items`, `features.plans.note`, `graphics`, `listing.current.iap` |
| [#f-inventory](tabs/04-features-comparison.md#f-inventory) | What ships | What ships in the app | [L63](../tabs/04-features-comparison/index.html#L63) | `renderFeatures()` [L480-532](../assets/app.js#L480) | `data.apps`, `data.board.US`, `data.claims`, `data.markets`, `data.profiles.claims`, `features.audit`, `features.edges`, `features.inventory`, `features.oursOnly`, `features.plans.items`, `features.plans.note`, `graphics`, `listing.current.iap` |
| [#f-edges](tabs/04-features-comparison.md#f-edges) | Competitor strengths | Where competitors are strong | [L68](../tabs/04-features-comparison/index.html#L68) | `renderFeatures()` [L480-532](../assets/app.js#L480) | `data.apps`, `data.board.US`, `data.claims`, `data.markets`, `data.profiles.claims`, `features.audit`, `features.edges`, `features.inventory`, `features.oursOnly`, `features.plans.items`, `features.plans.note`, `graphics`, `listing.current.iap` |
| [#f-iap](tabs/04-features-comparison.md#f-iap) | IAP comparison | In-app purchase ranges | [L73](../tabs/04-features-comparison/index.html#L73) | `renderFeatures()` [L480-532](../assets/app.js#L480) | `data.apps`, `data.board.US`, `data.claims`, `data.markets`, `data.profiles.claims`, `features.audit`, `features.edges`, `features.inventory`, `features.oursOnly`, `features.plans.items`, `features.plans.note`, `graphics`, `listing.current.iap` |
| [#f-method](tabs/04-features-comparison.md#f-method) | Method | Where this comes from | [L83](../tabs/04-features-comparison/index.html#L83) | `renderFeatures()` [L480-532](../assets/app.js#L480) | `data.apps`, `data.board.US`, `data.claims`, `data.markets`, `data.profiles.claims`, `features.audit`, `features.edges`, `features.inventory`, `features.oursOnly`, `features.plans.items`, `features.plans.note`, `graphics`, `listing.current.iap` |
...
| Section | Menu label | Heading in the markup | Markup line | Filled by (assets/app.js) | Data read |
| --- | --- | --- | --- | --- | --- |
| [#graphics](tabs/05-competitors-graphics.md#graphics) |  | Competitor’s Graphics | [L28](../tabs/05-competitors-graphics/index.html#L28) | `renderGraphics()` [L555-604](../assets/app.js#L555)<br>`lbStep()` [L629-648](../assets/app.js#L629)<br>`applyGraphicsFilter()` [L605-623](../assets/app.js#L605) | `graphics.apps`, `graphics.captureNote`, `graphics.guidance`, `graphics.overview`, `graphics.patterns`, `graphics.requirements`, `graphics.scope`, `graphics.sources`, `graphics.table` |
| [#g-overview](tabs/05-competitors-graphics.md#g-overview) | Overview | Competitor’s Graphics | [L29](../tabs/05-competitors-graphics/index.html#L29) | `renderGraphics()` [L555-604](../assets/app.js#L555) | `graphics.apps`, `graphics.captureNote`, `graphics.guidance`, `graphics.overview`, `graphics.patterns`, `graphics.requirements`, `graphics.scope`, `graphics.sources`, `graphics.table` |
| [#g-icons](tabs/05-competitors-graphics.md#g-icons) | Icons | All 17 icons side by side — ours first | [L38](../tabs/05-competitors-graphics/index.html#L38) | `renderGraphics()` [L555-604](../assets/app.js#L555) | `graphics.apps`, `graphics.captureNote`, `graphics.guidance`, `graphics.overview`, `graphics.patterns`, `graphics.requirements`, `graphics.scope`, `graphics.sources`, `graphics.table` |
| [#g-features](tabs/05-competitors-graphics.md#g-features) | Feature graphics | All 17 feature graphics — ours first | [L47](../tabs/05-competitors-graphics/index.html#L47) | `renderGraphics()` [L555-604](../assets/app.js#L555)<br>`lbStep()` [L629-648](../assets/app.js#L629) | `graphics.apps`, `graphics.captureNote`, `graphics.guidance`, `graphics.overview`, `graphics.patterns`, `graphics.requirements`, `graphics.scope`, `graphics.sources`, `graphics.table` |
| [#g-apps](tabs/05-competitors-graphics.md#g-apps) | By app | Every asset, app by app — ours first | [L56](../tabs/05-competitors-graphics/index.html#L56) | `renderGraphics()` [L555-604](../assets/app.js#L555)<br>`applyGraphicsFilter()` [L605-623](../assets/app.js#L605) | `graphics.apps`, `graphics.captureNote`, `graphics.guidance`, `graphics.overview`, `graphics.patterns`, `graphics.requirements`, `graphics.scope`, `graphics.sources`, `graphics.table` |
| [#g-patterns](tabs/05-competitors-graphics.md#g-patterns) | Patterns | Cross-app design patterns | [L73](../tabs/05-competitors-graphics/index.html#L73) | `renderGraphics()` [L555-604](../assets/app.js#L555) | `graphics.apps`, `graphics.captureNote`, `graphics.guidance`, `graphics.overview`, `graphics.patterns`, `graphics.requirements`, `graphics.scope`, `graphics.sources`, `graphics.table` |
| [#g-guidance](tabs/05-competitors-graphics.md#g-guidance) | Guidance | Guidance for future graphics | [L81](../tabs/05-competitors-graphics/index.html#L81) | `renderGraphics()` [L555-604](../assets/app.js#L555) | `graphics.apps`, `graphics.captureNote`, `graphics.guidance`, `graphics.overview`, `graphics.patterns`, `graphics.requirements`, `graphics.scope`, `graphics.sources`, `graphics.table` |
| [#g-requirements](tabs/05-competitors-graphics.md#g-requirements) | Play requirements | Play Store production requirements | [L89](../tabs/05-competitors-graphics/index.html#L89) | `renderGraphics()` [L555-604](../assets/app.js#L555) | `graphics.apps`, `graphics.captureNote`, `graphics.guidance`, `graphics.overview`, `graphics.patterns`, `graphics.requirements`, `graphics.scope`, `graphics.sources`, `graphics.table` |
| [#g-scope](tabs/05-competitors-graphics.md#g-scope) | Scope | Scope, evidence and limitations | [L97](../tabs/05-competitors-graphics/index.html#L97) | `renderGraphics()` [L555-604](../assets/app.js#L555) | `graphics.apps`, `graphics.captureNote`, `graphics.guidance`, `graphics.overview`, `graphics.patterns`, `graphics.requirements`, `graphics.scope`, `graphics.sources`, `graphics.table` |
| [#g-sources](tabs/05-competitors-graphics.md#g-sources) | Sources | Sources | [L105](../tabs/05-competitors-graphics/index.html#L105) | `renderGraphics()` [L555-604](../assets/app.js#L555) | `graphics.apps`, `graphics.captureNote`, `graphics.guidance`, `graphics.overview`, `graphics.patterns`, `graphics.requirements`, `graphics.scope`, `graphics.sources`, `graphics.table` |
...
| `renderFeatures` | [L480-532](../assets/app.js#L480) | `data.apps`, `data.board.US`, `data.claims`, `data.markets`, `data.profiles.claims`, `features.audit`, `features.edges`, `features.inventory`, `features.oursOnly`, `features.plans.items`, `features.plans.note`, `graphics` |
| `gOn` | [L533-535](../assets/app.js#L533) | `graphics.apps` |
| `iconOf` | [L536-536](../assets/app.js#L536) |  |
| `fgOf` | [L537-537](../assets/app.js#L537) |  |
| `pkgOf` | [L538-539](../assets/app.js#L538) |  |
| `gFigure` | [L540-547](../assets/app.js#L540) | `data.board.US` |
| `gVisibility` | [L548-554](../assets/app.js#L548) | `data.board.US`, `data.profiles` |
| `renderGraphics` | [L555-604](../assets/app.js#L555) | `graphics.apps`, `graphics.captureNote`, `graphics.guidance`, `graphics.overview`, `graphics.patterns`, `graphics.requirements`, `graphics.scope`, `graphics.sources`, `graphics.table` |
| `applyGraphicsFilter` | [L605-623](../assets/app.js#L605) |  |
| `lbShow` | [L624-628](../assets/app.js#L624) |  |
| `lbStep` | [L629-648](../assets/app.js#L629) |  |
| `syncBar` | [L649-651](../assets/app.js#L649) |  |
| `renderScoped` | [L652-678](../assets/app.js#L652) |  |
