...
**"Where did this number come from?"** The Google Play scrape and scoring scripts are in [research/](../research/) ([research/README.md](../research/README.md) lists each file); the methods are also written out in each tab's Method section.
