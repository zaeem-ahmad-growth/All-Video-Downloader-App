...
- If it names a tab folder (`01-video-downloader`, `02-aso-playbook`, `03-playstore-metadata`, `04-features-comparison`), read `docs/backend/<that folder>.md` in full. It holds the full source of the code that draws the tab and the full data the tab reads.
